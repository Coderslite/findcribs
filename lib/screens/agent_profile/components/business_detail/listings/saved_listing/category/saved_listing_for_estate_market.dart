...
class SavedListingForEstateMarket extends StatefulWidget {
  const SavedListingForEstateMarket({Key? key}) : super(key: key);

  @override
  State<SavedListingForEstateMarket> createState() =>
      _SavedListingForEstateMarketState();
}

class _SavedListingForEstateMarketState
    extends State<SavedListingForEstateMarket> {
  ...
  void initState() {
    super.initState();
    propertyList = getSavedPropertyList();
