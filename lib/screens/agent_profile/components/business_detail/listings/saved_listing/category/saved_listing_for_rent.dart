...
class SavedListingForRent extends StatefulWidget {
  const SavedListingForRent({Key? key}) : super(key: key);

  @override
  State<SavedListingForRent> createState() => _SavedListingForRentState();
}

class _SavedListingForRentState extends State<SavedListingForRent> {
  ...
  handleFilter(String value) {
    setState(() {
      filteredList = firstList.where((element) {
        return element.propertyType!.toLowerCase() == 'rent';
      }).toList();
      // print(filteredList);
    });
  }
