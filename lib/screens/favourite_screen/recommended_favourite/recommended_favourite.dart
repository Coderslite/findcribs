...
class _RecommendedFavouriteState extends State<RecommendedFavourite> {
  ...
  handleGetAgents() async {
    getFavouriteAgentList('by-verified').then((value) {
      setState(() {
        isChecked = [];
        isLoading = false;
        allAgents = value;
                          ...
                          itemBuilder: (context, index) => Stack(
                            children: [
                                  ...
                                  children: [
                                    CircleAvatar(
                                      backgroundImage: NetworkImage(
                                        allAgents![index].profileImg == null
                                    ...
                                    Text(
                                      allAgents![index].businessName.toString(),
                              ...
                              Positioned(
                                top: 0,
                                right: 0,
                                child: isChecked.contains(allAgents![index].id)
                                    ? const CircleAvatar(
                                        radius: 10,
