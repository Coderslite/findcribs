...
class _AgentRegistrationState extends State<AgentRegistration> {
  ...
  // handleValidateBusinessName(String businessName) async {
  //   final prefs = await SharedPreferences.getInstance();
  //   setState(() {
  //     isChecking = true;
  //   });
  ...
  //   var token = prefs.getString('token');
  //   var businessNameValid = await http.post(
  //       Uri.parse("$baseUrl/agent/check-business-name-availability"),
  //       headers: {
  //         "Authorization": "$token",
  //       },
  //       body: {
  ...
  //   print(businessNameValid);
  //   if (businessNameValid.statusCode == 200) {
  //     // print("available");
  //     setState(() {
  //       message = 'available';
  //       isChecking = false;
