              ...
              children: [
                              ...
                              ? FormBuilderDropdown(
                                  ...
                                  onChanged: (value) {
                                    estateListingController
                                        .rentFrequency.value = value.toString();
                                  },
                                  items: [
                                    "Per Day",
                                    "Per Week",
                ...
                estateListingController.description.value == ''
                    ...
                    : FormBuilderTextField(
                        ...
                        initialValue: estateListingController.description.value,
                        onChanged: (value) {
                          estateListingController.description.value =
                              value.toString();
                        },
                ...
                estateListingController.propertyCondition.value == ''
                    ...
                    : FormBuilderDropdown(
                        name: 'propertyCondition',
                        isExpanded: true,
                        initialValue: estateListingController.propertyCondition,
                        onChanged: (value) {
                          estateListingController.propertyCondition.value =
                              value.toString();
                        },
                        ...
                        estateListingController.newfiles.isEmpty
                            ...
                            : SizedBox(
                                child: GridView.builder(
                                    shrinkWrap: true,
                                    itemCount:
                                        estateListingController.newfiles.length,
