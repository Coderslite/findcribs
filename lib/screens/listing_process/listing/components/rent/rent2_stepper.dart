...
class _Rent2StepperState extends State<Rent2Stepper> {
  ...
  final rentFeeFormKey = GlobalKey<FormBuilderState>();
  final cautionFeeFormKey = GlobalKey<FormBuilderState>();
  final serviceChargeFormKey = GlobalKey<FormBuilderState>();
                                        ...
                                        formatter
                                            .format((rentListingController.rentFee.value == ''
                                                ...
                                                : (int.parse(rentListingController.rentFee.value.toString())) +
                                                    (rentListingController.cautionFee.value == ''
                                                        ? 0
                                                        : (int.parse(rentListingController.cautionFee.value
                                                            .toString()))) +
