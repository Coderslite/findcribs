                            ...
                            children: [
                              ...
                              rentListingController.parkingSpace.value == ''
                                  ? FormBuilderDropdown(
                                      ...
                                      isExpanded: true,
                                      onChanged: (value) {
                                        rentListingController.parkingSpace
                                            .value = value.toString();
                                      },
                                      style: TextStyle(
                                        color:
                              ...
                              rentListingController.water.value == ''
                                  ? FormBuilderDropdown(
                                      ...
                                      isExpanded: true,
                                      onChanged: (value) {
                                        rentListingController.electricity
                                            .value = value.toString();
                                      },
                                      style: TextStyle(
                                        color:
                              ...
                              MultiSelectDialogField<String>(
                                ...
                                initialValue: rentListingController.facilities
    ...
    showModalBottomSheet(
        ...
        builder: (context) {
          return StatefulBuilder(builder: (context, changeState) {
            print(loadStateLgaController.data.length);
            print(loadStateLgaController.lga.length);
            return Container(
