                            ...
                            children: [
                              ...
                              saleListingController.parkingSpace.value == ''
                                  ? FormBuilderDropdown(
                                      ...
                                      isExpanded: true,
                                      onChanged: (value) {
                                        saleListingController.parkingSpace
                                        ...
                                        onChanged: (value) {
                                          if (value!.isEmpty) {
                                            saleListingController
                                                .saleFee.value = 0.toString();
                                          } else if (_saleFeeFormKey
                                              .currentState!
                                              .validate()) {
                                            final numericValue = int.tryParse(
                                                value.replaceAll(',', ''));
                              ...
                              FormBuilderDropdown(
                                ...
                                onChanged: (value) {
                                  if (value == 'Yes') {
                                    setState(() {
                                      saleListingController.negotiable.value =
                                          1;
                                    });
                                  } else {
                                    setState(() {
                              ...
                              saleListingController.description.value == ''
                                  ? FormBuilderTextField(
                                      ...
                                      onChanged: (value) {
                                        saleListingController.description
                                            .value = value.toString();
                                      },
                                      decoration: InputDecoration(
                                        border: OutlineInputBorder(
                                    ...
                                    child: MaterialButton(
                                      onPressed: () async {
                                        if (_formKey2.currentState!
                                                .validate() &&
                                            _saleFeeFormKey.currentState!
                                                .validate()) {
                                          var res = await saleListingController
