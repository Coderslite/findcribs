                        ...
                        FormBuilder(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const Text(
                                "Do you want to Collaborate with FindCribs LTD on Property Management services?",
                                style: TextStyle(
                                  // color: Colors.grey,
  ...
  handleRegisterAgent() async {
    if (_formKey.currentState!.validate()) {
      ...
      if (manageAllowed) {
        ...
        request.fields['category'] = 'Property_Owner';
        ...
        if (response.statusCode == 201) {
          ...
          AwesomeDialog(
            ...
            desc: "You are now a registered Property Owner on FindCribs.",
            showCloseIcon: true,
            btnOkOnPress: () {
        ...
        request.fields['systemManaged'] = manageAllowed == true ? '1' : '0';
