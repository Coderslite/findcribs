...
class _ProductMainDetailsState extends State<ProductMainDetails> {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      if (getSinglePropertyController.isLoading.isTrue) {
            ...
            children: [
                                ...
                                SizedBox(
                                  ...
                                  child: InkWell(
                                    ...
                                    child: CachedNetworkImage(
                                      imageUrl: property.image![index]['url'],
                                      fit: BoxFit.cover,
                                      width: 1000,
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: Text(
                        ...
                        //     " " +
                        capitalize(property.propertyCategory == 'Estate Market'
              ...
              Positioned(
                ...
                child: SmoothPageIndicator(
                  controller: _controller,
                  count: property.image!.isEmpty ? 1 : property.image!.length,
                  ...
                  property.propertyCategory != 'Estate Market'
                      ? Row(
                          ...
                          children: [
                            Column(
                              children: [
                                SvgPicture.asset("assets/svgs/bedroom.svg"),
                                const SizedBox(
                                  height: 10,
                                ),
                                Text(
                            ...
                            Column(
                              children: [
                                SvgPicture.asset("assets/svgs/bathroom.svg"),
                                const SizedBox(
                                  height: 10,
                                ),
                                Text(
